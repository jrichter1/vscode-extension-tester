...
import { WebDriver, Builder, until, By, setup } from 'monaco-page-objects';
...
export class VSBrowser {
    ...
    async start(codePath: string): Promise<VSBrowser> {
        ...
        setup(this.codeVersion, VSBrowser.baseVersion, path.resolve(__dirname, 'locators'), this._driver);
        return this;
    }
